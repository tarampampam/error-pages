...
(() => {
  ...
  const translations = f({
    [t("Access is forbidden to the requested page")]: f({
    ...
    [t("Attempt to brew coffee with a teapot is not supported")]: f({
    ...
    [t("HTTP Version Not Supported")]: f({
    ...
    [t("Here's what might have happened")]: f({
    ...
    [t("Please check your authorization data")]: f({
    ...
    [t("Please double-check the URL and try again")]: f({
    ...
    [t("Please try again in a few minutes")]: f({
    ...
    [t("Please try to change the request method, headers, payload, or URL")]: f({
    ...
    [t("Proxy Authentication Required")]: f({
    ...
    [t("Requested Range Not Satisfiable")]: f({
    ...
    [t("The \"Content-Length\" is not defined. The server will not accept the request without it")]: f({
    ...
    [t("The method specified in the request is not allowed")]: f({
    ...
    [t("The pre condition given in the request evaluated to false by the server")]: f({
    ...
    [t("The request could not be completed because of a conflict")]: f({
    ...
    [t("The request took longer than the server was prepared to wait")]: f({
    ...
    [t("The requested byte range is not available and is out of bounds")]: f({
    ...
    [t("The requested page is no longer available")]: f({
    ...
    [t("The requested page needs a username and a password")]: f({
    ...
    [t("The server can not find the requested page")]: f({
    ...
    [t("The server did not understand the request")]: f({
    ...
    [t("The server does not support the \"http protocol\" version")]: f({
    ...
    [t("The server is temporarily overloading or down")]: f({
    ...
    [t("The server met an unexpected condition")]: f({
    ...
    [t("The server received an invalid response from the upstream server")]: f({
    ...
    [t("The server will not accept the request, because the request entity is too large")]: f({
    ...
    [t("Too many requests in a given amount of time")]: f({
    ...
    [t("You may have mistyped the URL")]: f({
    ...
    [t("You must authenticate with a proxy server before this request can be served")]: f({
