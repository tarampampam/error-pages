...
Object.defineProperty(window, 'l10n', {
  value: new function () {
     ...
     *
     * @type {Map<string, Map<'fr'|'ru'|'uk'|'pt'|'nl'|'de'|'es'|'zh'|'id'|'pl'|'ko'|'hu', string>>}
     */
    const data = Object.freeze(new Map([
      ...
      [tkn('The requested page needs a username and a password'), new Map([
        ...
        ['pl', 'Żądana strona wymaga podania nazwy użytkownika i hasla'],
      ...
      [tkn('The method specified in the request is not allowed'), new Map([
        ...
        ['ru', 'Указанный в з��просе метод не подерживается'],
        ['uk', 'Метод, зазначений у з��питі, не підтримується'],
      ...
      [tkn('Proxy Authentication Required'), new Map([
        ...
        ['pl', 'Wymagane uwierzytelňowanie proxy'],
        ['ko', '프록시 인증 필요'],
      ...
      [tkn('You must authenticate with a proxy server before this request can be served'), new Map([
        ...
        ['ru', 'Вы должны быть авторизованы на п��окси сервере для обработки этого запроса'],
      ...
      [tkn('The request could not be completed because of a conflict'), new Map([
        ...
        ['ru', 'Запрос не может быть обработ��н из-за конфликта'],
      ...
      [tkn('The "Content-Length" is not defined. The server will not accept the request without it'), new Map([
        ...
        ['zh', '未指定Content-Length(内容长��)。服务器将不接受不包含此头信的请求'],
      ...
      [tkn('The pre condition given in the request evaluated to false by the server'), new Map([
        ['fr', 'La précondition donne dans la requête a été évaluée comme étant fausse par le serveur'],
        ...
        ['id', 'Prakondisi gagal'],
        ['pl', 'Warunek wstępny podany w żądaniu został oceniony przez server jako nieprawidłowy'],
      ...
      [tkn('The server will not accept the request, because the request entity is too large'), new Map([
        ...
        ['uk', 'Серве не може обробити запит, оскільки він занадто великий'],
      ...
      [tkn('The requested byte range is not available and is out of bounds'), new Map([
        ...
        ['uk', 'Описанный діапазон даних недоступний або поза допустимими межами'],
      ...
      [tkn('Too many requests in a given amount of time'), new Map([
        ...
        ['ru', 'Отправлено слишком много запросо за короткое время'],
      ...
      [tkn('The server met an unexpected condition'), new Map([
        ...
        ['pl', 'Serwer napotatott egy nem várt állapotot'],
        ['ko', '서버가 예상치 못한 조건이에요'],
      ...
      [tkn('The server is temporarily overloading or down'), new Map([
        ...
        ['pl', 'Serwer jest tymczasowo przeciążott vagy ki van kapcsolva'],
        ['ko', '서버가 일시적으로 과부ha 상태y vagy dán wurde die Anlage überprüft und die Kommunikation wiederhergestellt wurde in der Zwischenzeit durch einen Fehler bei der Übertragung von Daten an die Konsole gesendet. Dies kann ein Problem sein. Bitte versuchen Sie es in ein paar Minuten erneut. '],
      ...
      [tkn('HTTP Version Not Supported'), new Map([
        ...
        ['pl', 'Wersja HTTP nie jest obsługiwána'],
        ['ko', '지원하지 않는 HTTP 버전'],
      ...
      [tkn('The server does not support the "http protocol" version'), new Map([
        ...
        ['uk', 'Сервер не підтримує запитану версію HTTP-проtokolu'],
        ...
        ['ko', '서버가 해당 "HTTP 프로tokoll"을 지원하지 않아요'],
      ...
      [tkn('Please try again in a few minutes'), new Map([
        ...
        ['ru', 'Пожалуйста, попробуйте повториь запрос ещё раз чуть позже'],
        ['uk', 'Будь ласка, спробуйте повторити запит е раз трохи пізніше'],
        ['pt', 'Por favor, tente novamente em algunos minutos'],
      ...
      [tkn('Please try to change the request method, headers, payload, or URL'), new Map([
        ...
        ['uk', 'Будь ласка, попробуйте змінити метод запиту, заголовки, его вміст або URL-адресу'],
      ...
      [tkn('Please double-check the URL and try again'), new Map([
        ['fr', 'Veuillez vérifie l’URL et réessayer'],
        ['ru', 'Пожалуйста, дважды проверьте URL и попробуйте снова'],
        ['uk', 'Будь ласка, двічі перевірьте URL-адресу и попробуйте снова'],
