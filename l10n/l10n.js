Object.defineProperty(window, 'l10n', {
    value: new function () {
        ...
        const data = { // all keys should be in english (it is default/main locale)
            ...
            'Double-check the URL': {fr: 'Vérifiez l’URL', ru: 'Дважды проверьте URL', uk: 'Двічі перевіряйте URL-адресу'},
            ...
            'It was never here': {fr: 'Il n’a jamais été ici', ru: 'Он никогда не был здесь', uk: 'Він ніколи не був тут'},
            ...
            'Original URI': {fr: 'URI d’origine', ru: 'Исходный URI', uk: 'Вихідний URI'},
            ...
            'What happened?': {fr: 'Que s’est-il passé ?', ru: 'Что произошло?', uk: 'Що сталося?'},
